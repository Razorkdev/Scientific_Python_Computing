#In this python project we are gonna make a budget app, also we make a couple methods
#deposit, withdraw, get_balance(to return the current balance after), transfer(
#(this method should return True or False), check_founds(use the transfer, and withdraw)

#The display need to be clean. Whit an exact format.
...
def create_spend_chart(categories):
    spent_amounts = []
    # Get the total we spent in all the categories.
